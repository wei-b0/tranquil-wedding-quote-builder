...
export function createDefaultQuote(ownerEmail: string): QuoteRecord {
  ...
  return applyCoverageDefaults({
    ...
    preWeddingDeliverables: [
      ...
      "Main cinematic film around 4 to 5 minutes",
      "Save the date video",
      "5 to 6 reels",
      "Cinematic prewedding teaser",
    ],
    packages: [
      createPackage({
        name: "Classic",
        subtitle: "Clean coverage for intimate celebrations",
        badge: "Essential",
        recommended: false,
        basePrice: "125000",
        team: ["Photographer", "Videographer", "Candid Photographer"],
        items: [
          "2 full event coverages",
          "Complete raw photos and videos",
          "Selected edited photographs",
          "60-second teaser",
          "Highlight film",
          "4 to 5 reels",
        ],
        specialFeatures: ["1 custom frame"],
      }),
      createPackage({
        name: "Signature",
        subtitle: "Best-value storytelling with stronger cinematic coverage",
        badge: "Recommended",
        recommended: true,
        basePrice: "175000",
        team: [
        ...
        specialFeatures: ["2 custom frames", "AI face scanner"],
      }),
      createPackage({
        name: "Luxury",
        subtitle: "Expanded premium coverage for larger wedding stories",
        badge: "Premium",
        recommended: false,
        basePrice: "250000",
        team: [
        ...
        items: [
          "4 to 5 event coverages",
          "Complete raw data delivered on same day",
          "Unlimited professionally edited photos",
          "60-second teaser in 24 hours",
          "Highlight film",
          "Full wedding film",
        ...
        specialFeatures: [
          "3 designer frames",
          "AI face scanner",
          "One day free prewedding shoot in Delhi NCR",
        ],
      }),
    ],
    deliverables: [
